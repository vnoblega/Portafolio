...
const educacion = ref([
  {fecha: '2024', title: 'Técnicatura Universitaria en Programacion', descripcion: 'Cursando actualmente la Tecnicatura en programción.', enlace:'https://www.youtube.com/'},
]);
</script>
